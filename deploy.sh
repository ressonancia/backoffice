...
REMOTE_USER="backoffice"               # Replace with your remote server username
REMOTE_HOST="178.156.177.164" # Replace with your server IP or domain
REMOTE_PATH="/var/www/html/backoffice/"      # Path to the Nginx root on the server
SSH_KEY_NAME="id_rsa_ressonance_backoffice"      # Path to the Nginx root on the server
